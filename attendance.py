...
trainimagelabel_path = "TrainingImageLabel/Trainner.yml"  # Remove leading slash
studentdetail_path = "StudentDetails/studentdetails.csv"  # Remove leading slash
...
titl = tk.Label(
    window, text="Attendance 2.0", bg="black", fg="green", font=("arial", 27),
)
